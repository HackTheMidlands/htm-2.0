                ...
                <Grid fluid>
                    <Row>
                        <div>
                            ...
                            <p>
                                This isn’t the end for HackTheMidlands though! We’re really happy to announce that ✨ <span style="font-weight: bold"> we’ll be looking at evolving HackTheMidlands </span> ✨, with the intention of putting on smaller hackathons and similar events with that same chill vibe and welcoming environment that we’ve tried to create in the past. Some of these will be similar, whilst we imagine some of these might be a little more outside the box.
                            </p>
                            <p>
                            ...
                            <p>
                                <span style="font-weight: bold"> Tom, Liam, Helena, and the HackTheMidlands Team 💖 </span>
                            </p>
                        </div>
                    </Row>
                </Grid>
